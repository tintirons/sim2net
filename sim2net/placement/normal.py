...
In the normal placement model, a simulation area of a given size is chosen and
a given number of nodes are placed over it with the normal, i.e. Gaussian,
...
class Normal(Placement):
    """
    This class implements the normal placement model, in which a given number
    of nodes are placed over a simulation area with the normal probability
    distribution.
    """
